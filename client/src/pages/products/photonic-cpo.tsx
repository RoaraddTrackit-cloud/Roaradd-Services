...
export default function PhotonicCPOPage() {
      ...
      <div className="relative overflow-hidden">
        ...
        <section className="py-12 border-y border-white/10 bg-black/40 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              ...
              <div>
                <p className="text-3xl sm:text-4xl font-bold text-emerald-400 mb-1">800G / 1.6T</p>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Architectural Innovations</h2>
          ...
          >
            <GlassCard className="p-8 border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
              <div className="w-12 h-12 bg-cyan-500/10 rounded-xl flex items-center justify-center text-cyan-400 mb-6">
                <Zap className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold mb-3">85% Energy Elimination</h3>
            ...
            <GlassCard className="p-8 border-primary/20 hover:border-primary/40 transition-colors">
              <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary mb-6">
                <Layers className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold mb-3">2.5D/3D Wafer Packaging</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <GlassCard className="p-8 border-emerald-500/20 hover:border-emerald-500/40 transition-colors">
              <div className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-400 mb-6">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold mb-3">Red-Team Audited</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        <section id="calculator" className="py-20 bg-gradient-to-b from-black/60 to-background border-t border-white/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-3">AI Cluster Energy & ROI Calculator</h2>
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GlassCard className="p-12 border-cyan-500/30 relative overflow-hidden">
            <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none" />
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Request Executive Briefing & Datasheet</h2>
